<template>
  <div class="jnv-hero-detail">
    <div class="jnv-hero-detail__container" v-if="ready">
      <!-- PRIMARY AREA -->
...
<script setup>
  import HeroPotrait from './parts/HeroPortrait.vue'
  import HeroCore from './parts/HeroCore.vue'
  import HeroRole from './parts/HeroRole.vue'
  import HeroStat from './parts/HeroStat.vue'
  import HeroAbilities from './parts/HeroAbilities.vue'
  import HeroHistory from './parts/HeroHistory.vue'
      ...
      async onResponse({ response }) {
        if(response.status == 200) {
          ...
          heroCoreData.value = {
            ...
            attack_type: hero.value.attack_type,
